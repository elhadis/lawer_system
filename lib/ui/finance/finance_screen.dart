...
class _FinanceScreenState extends State<FinanceScreen> {
  ...
  Future<_FinanceData> _load() async {
    ...
    final rows = await _db.getCasesWithClient();

    final totals = await _db.getFinanceTotals();

    return _FinanceData(rows: rows, totals: totals);
      ...
      builder: (ctx, snap) {
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton.extended(
            ...
            icon: Icon(mobile ? Icons.share_rounded : Icons.picture_as_pdf_rounded),
          ...
          body: ListView(
            ...
            children: [
              ...
              const SectionHeader(
                ...
                title: 'الوضع المالي لكل قضية',

                subtitle: 'انقر على صف القضية لعرض سجل المدفوعات الكامل للموكّل',
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: _amountChip('الأتعاب', fees, AppColors.navy),
...
class _FinanceData {
  ...
  _FinanceData({required this.rows, required this.totals});
